...
namespace Project1
{
    public partial class project1b : System.Web.UI.Page
    {
        ...
        protected void bitwise_function_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            byte bit1 = Convert.ToByte(Session["bitwise1"]);
            byte bit2 = Convert.ToByte(Session["bitwise2"]);
            int bit_result = 0;
            if (operation == "&")
            {
        ...
        protected void red_128_SelectedIndexChanged(object sender, EventArgs e)
        {
            System.Web.UI.WebControls.DropDownList myList;
            myList = (System.Web.UI.WebControls.DropDownList)sender;
            string listID = myList.ID.ToString();
